...
============================
Core data fetching and processing logic. Queries Salesforce and the
data warehouse, merges the results, and returns DataFrames.

Called by run.py — do not run this file directly.
"""
